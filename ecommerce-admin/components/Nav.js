...
export default function Nav() {
    ...
    const activeLink = inactiveLink+' bg-white text-orange-400 rounded-l-lg';
...
return (
    <aside className="text-white p-4 pr-0">
        ...
        <Link href={'/'} className={pathname === '/' ? activeLink : inactiveLink}>
            ...
            <Link href={'/produits'} className={pathname.includes('/produits') ? activeLink : inactiveLink}>
            ...
            <Link href={'/catégories'} className={pathname.includes('/catégories') ? activeLink : inactiveLink}>
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
  ...
  <path d="M5.5 5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1m0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3M1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1z"/>
            ...
            <Link href={'/parametres'} className={pathname.includes('/parametres') ? activeLink : inactiveLink}>
